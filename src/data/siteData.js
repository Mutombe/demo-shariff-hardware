...
const siteData = {
  business: {
    name: "Shariff Hardware",
    legalName: "Shariff Hardware",
    tagline: "Quality Building Materials & Hardware Supplies",
    description: "Shariff Hardware has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
    phone: "+263 77 630 2604",
    phoneRaw: "+263776302604",
    whatsappNumber: "263776302604",
    email: "info@shariffhardware.co.zw",
    address: "Shop N0.3 Corner Robert Mugabe, & Harare St, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "shariff-hardware-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Shariff", logoLine2: "Hardware" },
  ...
  homeTestimonials: [
    { text: "Shariff Hardware has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    ...
    { text: "Bulk delivery is always on time and the prices are competitive. Shariff Hardware is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Shariff Hardware has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
  ...
  reviews: {
    ...
    items: [
      { text: "Shariff Hardware has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5 },
      ...
      { text: "Bulk delivery is always on time and the prices are competitive. Shariff Hardware is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Shariff Hardware exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Shariff Hardware to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Shariff Hardware is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Shariff Hardware has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Shariff Hardware! I would like to request a quote.",
